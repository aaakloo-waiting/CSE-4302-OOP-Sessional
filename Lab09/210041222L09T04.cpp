...
bool compareShapeArea(const TwoDimensionalShape* a, const TwoDimensionalShape* b) {
    return a->getArea() > b->getArea();
}

void sortShapeArea(TwoDimensionalShape** a, int sz){
    sort(a, a+sz, compareShapeArea);
}
